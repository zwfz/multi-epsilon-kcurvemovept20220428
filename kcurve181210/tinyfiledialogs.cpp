/*_________
/         \ tinyfiledialogs.c v3.1.2 [Oct 2, 2017] zlib licence
	...
	wchar_t const* const aIconType) /* L"info" L"warning" L"error" */
{
	...
	lTitleLen = (int)(aTitle ? wcslen(aTitle) : 0);
	lMessageLen = (int)(aMessage ? wcslen(aMessage) : 0);
